...
describe("v4 match modes", () => {
  it("defines personal, 3v3, and 2v2v2 with scaled team targets", () => {
    expect(MATCH_MODES).toEqual(["solo", "team3v3", "team2v2v2", "domination3v3", "domination2v2v2", "teamElimination3v3"]);
    ...
    expect(getModeDefinition("teamElimination3v3" as never)).toMatchObject({ teamCount: 2, teamSize: 3, objective: "elimination" });
